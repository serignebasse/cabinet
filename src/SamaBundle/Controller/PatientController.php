...
use SamaBundle\Entity\Patient;
use SamaBundle\Form\PatientType;
...
class PatientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $patients = $em->getRepository('SamaBundle:Patient')->findAll();
    ...
    {
        $patient = new Patient();
        $form = $this->createForm('SamaBundle\Form\PatientType', $patient);
    ...
    {
        $deleteForm = $this->createDeleteForm($patient);
        $editForm = $this->createForm('SamaBundle\Form\PatientType', $patient);
